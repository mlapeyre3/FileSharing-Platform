 ...
 */
public class SetUsers extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!inputJSON.has("token") || !inputJSON.has("group_id") || !inputJSON.has("members")) {
            resp = JSONError.errorResp(resp, "The JSON is not well formatted");
            return;
        }
        ...
        try {
            ...
            if(!rs.next()) {
                ...
                resp = JSONError.errorResp(resp, "The client is not a member of the group or the group does not exist", inputJSON);
                return;
            }
